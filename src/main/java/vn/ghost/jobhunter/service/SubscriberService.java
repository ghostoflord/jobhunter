...
import vn.ghost.jobhunter.domain.Subscriber;
import vn.ghost.jobhunter.domain.response.email.ResEmailJob;
import vn.ghost.jobhunter.repository.JobRepository;
import vn.ghost.jobhunter.repository.SkillRepository;
import vn.ghost.jobhunter.repository.SubscriberRepository;
